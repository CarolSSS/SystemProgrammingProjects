...
vector *vector_create(copy_constructor_type copy_constructor,
    ...
    vec->array = (void **)malloc(INITIAL_CAPACITY * sizeof(void *));
    // size_t i = 0;
    // for (i = 0; i < vec->capacity; i++) {
    //     vec->array[i] = vec->default_constructor();
    // }
    return vec;
}
...
void vector_resize(vector *this, size_t n) {
    ...
    if (this->size > n) {
        ...
        // this->array = (void**)realloc(this->array, n * sizeof(void*));
        this->size = n;
...
void vector_reserve(vector *this, size_t n) {
    ...
    if (n > this->capacity) {
        ...
        // for (i = this->capacity; i < new_cap; i++) {
        //     this->array[i] = this->default_constructor();
        // }
